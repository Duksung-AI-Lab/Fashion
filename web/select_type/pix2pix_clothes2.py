...
def pix2pix(output_dir, input_dir, checkpoint):
    ...
    # with open(os.path.join(output_img, "options.json"), "w") as f:
    #     f.write(json.dumps(vars(None), sort_keys=True, indent=4))
...
def set_checkpoint(clothes):
    if clothes == "shirts":
        checkpoint = '/hdd_ext/hdd1/lhy0807/pix2pix-tensorflow-master/result/result_colorback_16500_200/'  # 셔츠
    elif clothes == 'tshirts':
        checkpoint = ''  # 티셔츠
    else:
        checkpoint = '/hdd_ext/hdd1/lhy0807/pix2pix-tensorflow-master2/result/result_denim_9483/'  # 청바지(아직 색상 적용X)
...
def exe_pix2pix(collar, timestamp):
    global global_timestamp
    ...
    try:
        input_dir = "/hdd_ext/hdd2/lhy0807/pix2pix_clothes/shirts/" + collar + "/"
