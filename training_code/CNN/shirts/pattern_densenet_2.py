...
data_path = '/home/lhy0807/python_maskrcnn/dataset/pattern_5class/'
image_size = (224, 224)
...
model.compile(optimizer=optimizers.Adam(0.001),  # Very low learning rate
...
model.save(os.path.join(data_path, 'models/transfer_densenet_E20_3.h5'))