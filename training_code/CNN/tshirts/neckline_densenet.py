...
data_path = '../DataSet/neckline_dataset'
...
print("layer_len", len(transfer_model.layers))
...
model.summary()
model.compile(loss='categorical_crossentropy', optimizer=optimizers.Adam(lr=0.0002), metrics=['acc'])
...
#
# for layer in transfer_model.layers[:142]:
